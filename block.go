...
// Tx returns a wrapped transaction (navutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (navutil.Tx) for all
...
// instead provides easy access to wrapped versions (navutil.Tx) of them.
