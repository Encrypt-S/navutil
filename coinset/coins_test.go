...
import (
	...
	"github.com/navcoin/navutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    navutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() navutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value navutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 0.035NAV value.
	...
	testSimpleCoinTxValue0            = navutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = navutil.NewTxFromBytes(testSimpleCoinTxBytes)
